...
class TMK(nn.Module):
    def __init__(self, in_feature=8, n_level=2,
        ...
        if in_feature == 1:  # one-dimension TMGP
            ...
            eta = int(in_feature + n_level)
            sg = SparseGridDesign(in_feature, eta, input_bd=input_bd, design_class=design_class).gen_sg(
    ...
    def forward(self, x):
        ...
        self.sparse_grid: [m,d] size tensor, sparse grid points X^{SG} of dyadic sort
