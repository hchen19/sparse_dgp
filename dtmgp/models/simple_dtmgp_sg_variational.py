...
from dtmgp.layers.tmgp import SparseGridTMGP
...
class SDTMGPsg(nn.Module):
    def __init__(self, 
        ...
        self.tmk1 = SparseGridTMGP(in_features=input_dim, n_level=3, design_class=design_class, kernel=kernel)
        ...
        self.tmk3 = SparseGridTMGP(in_features=w2, n_level=3, design_class=design_class, kernel=kernel)
