...
from dtmgp.layers.tmgp import AddTMGP
...
class SDTMGPadd(nn.Module):
    def __init__(self, 
        ...
        self.tmk1 = AddTMGP(in_features=input_dim, n_level=6, design_class=design_class, kernel=kernel)
        ...
        self.tmk2 = AddTMGP(in_features=w1, n_level=6, design_class=design_class, kernel=kernel)
        ...
        self.tmk3 = AddTMGP(in_features=w2, n_level=6, design_class=design_class, kernel=kernel)
