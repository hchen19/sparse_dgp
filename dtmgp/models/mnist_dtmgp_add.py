...
class DTMGPmnist(nn.Module):
    def __init__(self, 
        ...
        #################################################################################
        # return [n, m1] size tensor for [n, input_dim] size input and [m1, input_dim] size sparse grid
        self.tmk1 = AdditiveTMGP(in_features=input_dim, n_level=2, design_class=design_class, kernel=kernel)
        ...
        self.tmk2 = AdditiveTMGP(in_features=w1, n_level=3, design_class=design_class, kernel=kernel)
