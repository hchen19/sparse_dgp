...
from dtmgp.layers import LinearReparameterization, Conv2dReparameterization
from dtmgp.layers import AMGP
...
class DAMGPmnist(nn.Module):
    def __init__(self, 
        ...
        self.tmk1 = AMGP(in_features=100, n_level=4, design_class=design_class, kernel=kernel)
        ...
        self.tmk2 = AMGP(in_features=w1, n_level=4, design_class=design_class, kernel=kernel)
